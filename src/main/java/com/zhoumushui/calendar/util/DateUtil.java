...
public class DateUtil {
    ...
    final static String chineseNumber[] = {"一", "二", "三", "四", "五", "六", "七", "八", "九",
            "十", "十一", "十二"};
    ...
    final private static String cyclicalm(int num) {
        final String[] Gan = new String[]{"甲", "乙", "丙", "丁", "戊", "己", "庚", "辛", "壬",
                "癸"};
    ...
    public static String getLunarDateByCalendar(Calendar calendar) {
        ...
        for (iMonth = 1; iMonth < 13 && offset > 0; iMonth++) {
            if (leapMonth > 0 && iMonth == (leapMonth + 1) && !leap) { //闰月
                --iMonth;
                leap = true;
            ...
            offset -= daysOfMonth;
            if (leap && iMonth == (leapMonth + 1)) leap = false; //解除闰月
            if (!leap) monCyl++;
        }
